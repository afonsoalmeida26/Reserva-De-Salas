...
*Automação de tarefas (Cron Jobs)*: Verificação de faltas, onde são verificadas as reservas onde não foram efetuados Check-in's. cancelando-as e registando as respetivas faltas. Atualização automática do estado de reservas para "A decorrer", às quais estejam com Check-In feito e estejam dentro da sua hora.


### FERRAMENTAS UTILIZADAS ###
JWT (Autenticação segura), psycopg (Base de Dados), Flask (Rotas)
